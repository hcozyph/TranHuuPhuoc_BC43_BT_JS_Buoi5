...
document.getElementById('bt4-btn').onclick = function () {
    ...
    */ 
    ...
    if (typeOfValue !== 2 ){
        ...
        result = handlingFee + basicServiceFee + highClassChannelFee;
    } 
    ...
    //print-result
    document.getElementById('bt4-result').innerHTML = 'Mã khách hàng: ' + customerID + '. Tiền cáp là: $' + result;  
