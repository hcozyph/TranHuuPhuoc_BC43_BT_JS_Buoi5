...
document.getElementById('btnResult1').onclick = function () {
    ...
    */
    ...
    if (    score >= benchmark && 
            ...
            document.getElementById('result1').innerHTML = 'Tổng điểm là ' + score + '. Chúc mừng bạn đã đậu.'
    } else {
        document.getElementById('result1').innerHTML = 'Tổng điểm là ' + score + '. Rất tiếc, bạn đã rớt, cố gắng lần sau nhé !' 
    }
