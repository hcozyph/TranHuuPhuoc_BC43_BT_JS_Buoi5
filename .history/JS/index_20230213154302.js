...
document.getElementById('bt2-btn').onclick = function() {
    ...
    //output
    var result      = 0;
    var htmlString  = 'Tổng tiền điện của nhà ' + name + ' là ' + result.toLocaleString() + ' vnđ';
    /*condition
    ...
    */
    ...
    // document.getElementById('bt2-result').innerHTML = 'Tổng tiền điện của nhà ' + name + ' là ' + result.toLocaleString() + ' vnđ';
