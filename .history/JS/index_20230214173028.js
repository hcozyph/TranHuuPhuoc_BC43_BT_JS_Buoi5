...
function hideOrShow() {
    var x = String(document.getElementById('bt4-selectType').value);
    if (x = 1 ) {
        document.getElementById('bt4-inputConnection').style.display = 'none';}
    else if ( x = 2 ) {
        document.getElementById('bt4-inputConnection').style.display = 'block !important' ;
    }
}
