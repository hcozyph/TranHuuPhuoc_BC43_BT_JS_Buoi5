...
document.getElementById('btnResult1').onclick = function () {
    ...
    */
    ...
    if (    score >= benchmark && 
            ...
            document.getElementById('result1').innerHTML = 'Chúc mừng bạn đã đậu. Tổng điểm là ' + score
    } else {
        document.getElementById('result1').innerHTML = 'Chia buồn bạn đã rớt. Tổng điểm là ' + score
    }
